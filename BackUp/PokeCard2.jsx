...
import PokeNick from './PokeNick'
  ...
  const { pokeList, candidatePokes, setCandidatePokes, url, myTeam, setMyTeam, initialHighlightState,storedPokes, setStoredPokes } = props  
...
return (
    ...
    <li className={amIHighlighted}>
        ...
        <PokeInput key={url+"p2input"} nick={nick} setNick={setNick} showNick={showNick} setShowNick={setShowNick}/>
        <PokeNick key={url+"p2nick"} nick={nick} setNick={setNick} showNick={showNick}/>
        Abilities:<br></br>
